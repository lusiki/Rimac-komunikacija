...
subtitle: "Medijska analiza tvrtke Rimac"
output:
...
<br>
```{r words, echo=FALSE, message=FALSE, warning=FALSE, eval = TRUE}
...
```{r brandOverTime, echo=FALSE, message=FALSE, warning=FALSE, fig.height = 3, fig.width = 5, eval = TRUE}
